...
python clean_codes_v2/run_train_pipeline.py --config-file train_2_2.json --train 0 --N 1 --fresh_run 0 > logs/lc1.log 2>&1 && \
...
python clean_codes_v2/run_train_pipeline.py --config-file train_2_2.json --train 1 --fresh_run 0 > logs/train_rsrp_2_5.log 2>&1
